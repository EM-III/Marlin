 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45.6, -5.9, -2.33 } //MIJ
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  //MIJ
...
#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 125   // (°C) Only applies to E0 at this time //MIJ
